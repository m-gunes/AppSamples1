...
public class CountDownSchedulerTimeUnitConstructorTest {
    ...
    private static final long PERIOD_IN_SECONDS = 1;
    private static final long PERIOD_IN_MILLISECONDS = PERIOD_IN_SECONDS * 1000;
    ...
    void test()
    {
        ...
        ThreadUtil.sleep(PERIOD_IN_MILLISECONDS + 3000);
    }
}
