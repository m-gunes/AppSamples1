package org.csystem.app.collections.device;
...
public class DeviceDataSource {
    ...
    private String getHost()
    {
        return "%d.%d.%d.%d".formatted(
                m_randomGenerator.nextInt(0, 256),
                m_randomGenerator.nextInt(0, 256),
                m_randomGenerator.nextInt(0, 256),
                m_randomGenerator.nextInt(0, 256)
        );
    ...
    {
        return m_randomGenerator.nextBoolean()
                ? StringUtil.randomText(m_randomGenerator, m_randomGenerator.nextInt(4, 6), "_?:=)_")
                : null;
